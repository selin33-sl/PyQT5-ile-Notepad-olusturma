...
from PyQt5.QtWidgets import QWidget,QFileDialog,QApplication,QTextEdit,QLabel,QPushButton,QVBoxLayout,QHBoxLayout
...
class Menu(QMainWindow):
    ...
    def menuleri_olustur(self):
        ...
        dosyayı_temizle=QAction("Dosyayı Temizle",self)
        dosyayı_temizle.setShortcut("Ctrl+D")
        ...
        dosya.addAction(dosyayı_temizle)
    ...
    def response(self,action):
        if action.text()== "Dosya Aç":
            ...
            print("Dosyayı Temizle'ye basıldı.")
